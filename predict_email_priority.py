...
with open("email_priority_model.pkl", "wb") as file:
    pickle.dump((best_rf, vectorizer, label_encoder), file)

print("📌 Email priority model saved as 'email_priority_model.pkl'")
